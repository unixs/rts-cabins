...
struct InternalLight{
 ...
 float AutoOnWorldLit,Attenuation[4],ArrayStride[4],ArrayItemLength,SourceRadius;
 UINT ArraySize;
};
...
struct Cabin: public DLLInterfaceObject{
 ...
 inline ActChair *Chair(wchar_t *Name) const{
  return (ActChair *)RTSGetCabObjectByName(DLLHandle,this,RTSOT_Chair,Name,-1);
 };
 inline ActSeat *Seat(wchar_t *Name) const{
  return (ActSeat *)RTSGetCabObjectByName(DLLHandle,this,RTSOT_Seat,Name,-1);
 };
};
